...
hexahedron::hexahedron(PNT p0,PNT p1,PNT p2,PNT p3,PNT p4,PNT p5)
{
   r0 = a0 = p0;
   r1 = a1 = p1;
   r2 = a2 = p2;
...
void hexahedron::shexahedron(PNT p0,PNT p1,PNT p2,PNT p3,PNT p4,PNT p5)
{
   r0 = a0 = p0;
   r1 = a1 = p1;
   r2 = a2 = p2;
...
void hexahedron::rotate(PNT ax0,PNT ax1,float angle,char r)
{
   if (r == 'r')
   {
...
void hexahedron:: shift(PNT sh,char r)
{
   if (r == 'r')
   {
      r0 = r0 + sh;
